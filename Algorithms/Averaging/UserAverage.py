...
class UserAverage(PredictorBase):
    ...
    def predict(self, user_id, item_id, rating=0):
        ...
        elif ratings.user_ratings_count[user_id] == 0:
        ...
        # Return user_id ratings average
        return PredictionTrialSuccess(ratings.user_ratings_avg[user_id], 0, user_id, item_id, rating)